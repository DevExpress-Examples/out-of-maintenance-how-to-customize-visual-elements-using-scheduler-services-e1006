...
<body>
    ...
    <div>
        ...
        <Views>
            <DayView ResourcesPerPage="1" DayCount="3"><TimeRulers><cc1:TimeRuler UseClientTimeZone="False" ShowMinutes="True" TimeZoneId="Greenwich Standard Time" >
            </cc1:TimeRuler>
            ...
            <WorkWeekView NavigationButtonVisibility="Always" ResourcesPerPage="1"><TimeRulers><cc1:TimeRuler />
                <cc1:TimeRuler UseClientTimeZone="False" TimeZoneId="Greenwich Standard Time">
                </cc1:TimeRuler>
