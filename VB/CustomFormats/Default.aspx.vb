...
Partial Public Class _Default
	...
	Public Sub CreateAppointmentFormatStringService()
		Me.prevAppointmentFormatStringService = CType(ASPxScheduler1.GetService(GetType(IAppointmentFormatStringService)), IAppointmentFormatStringService)
	...
	Public Sub CreateTimeRulerFormatStringService()
		Me.prevTimeRulerFormatStringService = CType(ASPxScheduler1.GetService(GetType(ITimeRulerFormatStringService)), ITimeRulerFormatStringService)
	...
	Public Sub CreateHeaderCaptionService()
		Me.prevHeaderCaptionService = CType(ASPxScheduler1.GetService(GetType(IHeaderCaptionService)), IHeaderCaptionService)
	...
	Public Sub CreateHeaderToolTipService()
		Me.prevHeaderToolTipService = CType(ASPxScheduler1.GetService(GetType(IHeaderToolTipService)), IHeaderToolTipService)
